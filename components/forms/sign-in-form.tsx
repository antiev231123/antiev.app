...
export function SignInForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Mock authentication - in production, connect to your auth provider
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button
          type="button"
          className="h-12 border border-border text-foreground text-sm font-medium transition-colors hover:bg-secondary flex items-center justify-center gap-2"
        >
